"""
Django settings for testapp_45710 project.
...
ROOT_URLCONF = 'testapp_45710.urls'
...
WSGI_APPLICATION = 'testapp_45710.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_45710 API",
    "DESCRIPTION": "API documentation for testapp_45710 App",
    "VERSION": "v1",
}
